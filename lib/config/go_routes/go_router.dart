...
import 'package:fluffychat/zeon/pages/about/zeon_about_page.dart';
      ...
      routes: [
        GoRoute(
          ...
          routes: [
            ...
            // Zeon "我的" / Profile entry — Sovereign-style profile screen.
            // Shows avatar / nickname / UID, the locally-held wallet address
            // (only visible to self), and the settings shortcut list.
            GoRoute(
              path: 'me',
              pageBuilder: (context, state) =>
            ...
            GoRoute(
              path: 'zeon-about',
              pageBuilder: (context, state) =>
                  defaultPageBuilder(context, const ZeonAboutPage()),
              redirect: loggedOutRedirect,
            ),
            GoRoute(
              path: 'notifications',
