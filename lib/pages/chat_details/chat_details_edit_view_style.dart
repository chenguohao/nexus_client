...
class ChatDetailEditViewStyle {
  ...
  static const EdgeInsetsGeometry doneIconPadding = EdgeInsets.symmetric(
    vertical: 8,
    horizontal: 4,
  );
  ...
  static const EdgeInsets editAvatarPadding = EdgeInsets.symmetric(
    vertical: 8.0,
    horizontal: 20.0,
  );
  ...
  static const EdgeInsetsDirectional contentPadding = EdgeInsetsDirectional.all(
    16.0,
  );
